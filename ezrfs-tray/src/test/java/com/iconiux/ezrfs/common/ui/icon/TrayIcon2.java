 ...
 * @since 0.0.1
 */
public class TrayIcon2 extends java.awt.TrayIcon {
...
//	}
	...
	public TrayIcon2(final Image image, final String tooltip, final PopupMenu popup) {
		super(image, tooltip, popup);
//		if (log.isTraceEnabled()) log.trace(HelperLog.constructor(image, tooltip, popup));
	}

	public TrayIcon2(final Image image, final String tooltip) {
		super(image, tooltip);
//		if (log.isTraceEnabled()) log.trace(HelperLog.constructor(image, tooltip));
	}

	public TrayIcon2(final Image image) {
		super(image);
//		if (log.isTraceEnabled()) log.trace(HelperLog.constructor(image));
	...
	public TrayIcon2(final Image image, final String tooltip, final JPopupMenu popup) {
		this(image, tooltip);
//		if (log.isTraceEnabled()) log.trace(HelperLog.constructor(image, tooltip, popup));
